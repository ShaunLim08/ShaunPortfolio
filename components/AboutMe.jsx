...
const AboutMe = () => {
  ...
  useEffect(() => {
    if (tabsRef.current) {
      const activeTab = tabsRef.current.querySelector(`button[data-tab="${tab}"]`)
      if (activeTab) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 py-16 items-center">
        ...
        <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
          ...
          <p className="text-base text-justify lg:text-lg">
            I am a Year 3 Computer Science student with a passion for Web3 and technology. My experiences usually
            revolve around community building, product management, and participating in hackathons. I am always looking
            for opportunities to learn and grow, and I am excited to see where my journey will take me.
          </p>
